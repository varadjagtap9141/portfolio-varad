    ...
    <div class="services-container">
      ...
      <div class="services-box">
        ...
        <p>
          ...
          Leveraging PHP for dynamic server-side functionalities, CodeIgniter 3 for structured MVC-based development,
    ...
    <div class="resume-container">
      <div class="resume-box">
        ...
        <p style="margin-bottom: 20px;">
          I am a full-stack web developer with a Computer Science degree and hands-on experience in PHP, frontend, and
          backend development. Skilled in HTML, CSS, JavaScript, Bootstrap, and CodeIgniter 3, I specialize in building
          dynamic, user-friendly web solutions. With real-world project experience. I excel in problem-solving, collaboration, and delivering innovative solutions while staying
        ...
        <div class="resume-detail Experience active">
          ...
          <div class="resume-list">
            <div class="resume-item">
              ...
              <p>
                Gained hands-on experience in full-stack development, building dynamic web applications using PHP, and
                modern
                front-end technologies.
                Contributed to real-world projects, enhancing problem-solving skills and applying theoretical knowledge
                in a professional
                environment.
                Led a team of developers, coordinating tasks and ensuring successful project completion within
                deadlines.
                Collaborated with team members to design, develop, and debug code, ensuring optimal performance and
                usability.
              </p>
            </div>
          </div>
      ...
      <div class="portfolio-box">
        <div class="portfolio-detail active">
          ...
          <div class="live-github">
            ...
            <a href="https://github.com/varadjagtap9141/varad_interiors" target="_blank" rel="noopener noreferrer"><i
        ...
        <div class="portfolio-detail">
          ...
          <p>
            Designed and developed a comprehensive retail management software to streamline cloth store operations. Key
            features
            include category and brand management, product size tracking, supplier and customer management, stock
            monitoring,
            invoicing and sales/purchase reporting with CSV/PDF export. Integrated financial tracking for payments, dues
            and
            balances.
          </p>
          <div class="tech">
        ...
        <div class="portfolio-detail">
          ...
          <p>
            Medilab is a healthcare-focused CMS that enables easy management of services, doctors, and testimonials. It
            features a
            secure admin panel for real-time content updates, a responsive design, and SEO-friendly architecture,
            ensuring an
